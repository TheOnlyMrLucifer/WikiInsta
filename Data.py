...
By ✨ WikiLeaks ✨ @TheOnlyMrLucifer
    ...
    # Rest Buttons
    buttons = [
        [InlineKeyboardButton("✨ More Bots And Updates ✨", url="https://t.me/WikiLeaksBots")],
        [
            InlineKeyboardButton("How to Use ❔", callback_data="help"),
            InlineKeyboardButton("🎪 About 🎪", callback_data="about")
        ],
        [InlineKeyboardButton("✨ More Amazing bots ✨", url="https://t.me/WikiLeaksBots")],
    ]
...
A telegram bot to download instagram content by @TheOnlyMrLucifer

Source Code : [Click Here](https://github.com/TheOnlyMrLucifer/WikiInsta)

Framework : [Pyrogram](docs.pyrogram.org)

Language : [Python](www.python.org)

Developer : @TheOnlyMrLucifer
    """
